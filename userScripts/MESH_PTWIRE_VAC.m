...
m.sink.temperature = 307;
% Ambient temperature in K
m.ambientTemperature = 307;
% Temperature of cooling unit
m.coolingTemperature = 305;
...
m.source.rate = @heatingRate_PtWire_Vac;
...
m.sample.ViscousLossCoefficient = 4e19; % 2.5
