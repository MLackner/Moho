...
HSpos = [...
    5e-3, 8e-3, 5e-3, 8e-3, dims(3), dims(3);
    ];
...
m.sink.lossCoefficient = 0.0018706*m.sink.heatCapacity;
...
m.source.rate = @heatingRate_Ramp5V;
